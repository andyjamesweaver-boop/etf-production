...
<p>The Quay funds deserve particular attention. Quay, distributed by Bennelong, listed two variants of its global real estate strategy simultaneously in November 2025 — a hedged and an unhedged version — and collectively attracted <strong>$1.24 billion</strong> in assets in under four months. For context, that is a faster ramp than most large passive ETFs achieved in their first year of trading.</p>

<h2>What is driving the wave?</h2>
<p>Several forces are converging. The ASX's mFund settlement service and broker platform integrations have made it easier for financial advisers to hold managed funds in ETF wrapper form without the administrative overhead of traditional unlisted trusts. Many of the 2025 launches are conversions or co-listings of pre-existing unlisted managed funds — Ausbil's DIVI and the Quay funds both had established track records before listing. The ETF wrapper improves liquidity, transparency and tax efficiency while preserving the active management approach.</p>
