...
<p>The Quay funds warrant a closer look — and a note of caution on the headline FUM figures. QGFH and QGRU listed in November 2025 via a <strong>Dual Access</strong> structure, which allows existing investors in Quay's unlisted managed fund to exchange their units directly into the listed ETF class without selling and rebuying on market. The $1.24 billion reported in assets largely reflects that in-specie transfer of pre-existing capital — investors who were already in the Quay strategy moving into the more liquid ETF wrapper — rather than net new money entering the market. That is a meaningful distinction: it tells us the ETF wrapper was preferred over the unlisted fund, but it does not indicate that $1.24 billion of fresh investment was attracted by the ETF launch itself.</p>

<h2>What is driving the wave?</h2>
<p>Several forces are converging. The dominant mechanism is the <strong>conversion or co-listing</strong> of pre-existing unlisted managed funds into ETF form. Managers with established track records — Ausbil's DIVI, the Quay funds, and many others — are adding an ETF class to their existing fund structure, allowing both existing and new investors to access the same strategy through a broker account. The ETF wrapper improves liquidity, simplifies custody and administration for financial advisers, and provides intraday pricing — without requiring the fund manager to change the underlying investment approach.</p>
